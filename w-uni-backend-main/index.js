...
//----------------------------- MongoDB Connection -----------------------------------
const uri = "mongodb+srv://rezwanjoy457:MGQPTNOdQdiYeIBT@cluster0.dvxwauv.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    const modifiedUniversitiesCollection = client.db("world_uni").collection("modifiedUnis");
    const universitiesCollection = client.db("world_uni").collection("universities");
